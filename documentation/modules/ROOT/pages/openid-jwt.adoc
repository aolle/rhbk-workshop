...
At this point, we only have to configure some properties to indicate where and how use the OIDC server:
...
So, enter in the RHBK admin console, go to the "users" section and press the "add user" button.
...
====
For this example, you can use whatever password you want, but I recommend to use an easy password as "reader". 
====
...
If we click the green button, the application redirect us to Keycloak login page.
